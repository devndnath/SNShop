    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title f-w-600" id="exampleModalLabel">Update Brand</h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal"
                    aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{ url('admin/brand/'.$brand->id)}}"
                ...
                <div class="modal-body">
                    ...
                    <div class="form">
                        ...
                        <div class="form-group mb-0">
                            <label for="validationCustom03"
                                class="mb-1">Brand Image :</label>
                            <input class="form-control" id="validationCustom02"
                                type="file" name="image">
                                @if($brand->image)
                                <img src="{{asset('uploads/brand/'.$brand->image)}}" width="60px" height="60px" alt=""/>
                                @endif
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                ...
                <div class="modal-footer">
                    <a href="{{url('admin/brand/'.$brand->id.'/delete')}}">
