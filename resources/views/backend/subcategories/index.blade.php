                                    ...
                                    <tbody>
                                        @foreach ($subcategory as $subcategory)
                                            <tr>
                                                ...
                                                <td data-field="name">{{ $subcategory->slug }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#">
                                                        ...
                                                        data-original-title="test"
                                                        data-bs-target="#deleteModal{{$subcategory->id}}" title="Delete"></i>
                                                    </a>
                                                </td>
                                            </tr>
                                           @include('backend.subcategories.modal')
                                        @endforeach
        ...
        <div class="modal fade" id="exampleModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('admin/sub-category') }}"  method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select selectcategory" name="parent_category" id="">
                                        <option value="1" selected>Please Select Parent Category</option>
