                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img
                                                        ...
                                                        src="{{asset('frontend/assets/images/dashboard/user2.jpg')}}" alt=""
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img
                                                        class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded"
                                                        src="{{asset('frontend/assets/images/dashboard/user1.jpg')}}" alt=""
                                                        data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img
                                                        class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded"
                                                        src="{{asset('frontend/assets/images/dashboard/user3.jpg')}}" alt=""
                                                        data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img
                                                        class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded"
                                                        src="{{asset('frontend/assets/images/dashboard/user.jpg')}}" alt=""
                                                        data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img
                                                        class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded"
                                                        src="{{asset('frontend/assets/images/dashboard/designer.jpg')}}" alt=""
                                                        data-original-title="" title="">
                                                    <div class="d-inline-block">
...
&lt;tr&gt;
    &lt;td class="bd-t-none u-s-tb"&gt;
        &lt;div class="align-middle image-sm-size"&gt;&lt;img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('frontend/assets/images/dashboard/user3.jpg')}}" alt="" data-original-title="" title=""&gt;
        &lt;div class="d-inline-block"&gt;
...
&lt;tr&gt;
    &lt;td class="bd-t-none u-s-tb"&gt;
        &lt;div class="align-middle image-sm-size"&gt;&lt;img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{asset('frontend/assets/images/dashboard/user.jpg')}}" alt="" data-original-title="" title=""&gt;
        &lt;div class="d-inline-block"&gt;
