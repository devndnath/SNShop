                                                ...
                                                <ul class="mega-menu tp-submenu">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="/shop"><img
                                                                        src="{{ asset('frontend/assets/img/header/menu/menu-1.jpg') }}"
                                                                        alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        <a href="/shop" class="mega-menu-title">Computer &
                                                            Laptops</a>
                                                        <ul>
                                                            <li>
                                                                <a href="/shop"><img
                                                                        src="{{ asset('frontend/assets/img/header/menu/menu-2.jpg') }}"
                                                                        alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="/shop"><img
                                                                        src="{{ asset('frontend/assets/img/header/menu/menu-3.jpg') }}"
                                                                        alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-2">
                                                            <div class="shop-mega-menu-list">
                                                                <a href="/shop" class="shop-mega-menu-title">Shop
                                                                    Pages</a>
                                                                <ul>
                                                            ...
                                                            <div class="shop-mega-menu-list">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><a href="shop-filter-offcanvas.html">Filters
                                                                            Offcanvas</a></li>
                                                                    <li><a href="/shop">Filters Sidebar</a></li>
                                                                    ...
                                                                    <li><a href="/shop">Hidden search</a></li>
                                                                    <li><a href="/shop">Search Full screen</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <div class="shop-mega-menu-list">
                                                                <a href="/shop" class="shop-mega-menu-title">Hover
                                                                    Style</a>
                                                                <ul>
                                                                    <li><a href="/shop">Hover Style 1</a></li>
                                                                    <li><a href="/shop">Hover Style 2</a></li>
                                                                    <li><a href="/shop">Hover Style 3</a></li>
                                                                    <li><a href="/shop">Hover Style 4</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="shop-mega-menu-img">
                                                                <img src="{{ asset('frontend/assets/img/menu/product/menu-product-img-1.jpg') }}"
                                                                    alt="">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="shop-mega-menu-img">
                                                                <img src="{{ asset('frontend/assets/img/menu/product/menu-product-img-2.jpg') }}"
                                                                    alt="">
                                                                <div class="shop-mega-menu-btn">
                                                                    <a href="shop-category.html"
                                                ...
                                                <ul class="tp-submenu tp-mega-menu mega-menu-style-2">
                                                    ...
                                                    <li class="has-dropdown">
                                                        ...
                                                        <ul class="tp-submenu">
                                                            ...
                                                            <li><a href="/shop">Shop Grid with Sideber</a></li>
                                                    ...
                                                    <!-- third col -->
                                                    <li class="has-dropdown">
                                                        <a href="/shop" class="mega-menu-title">eCommerce</a>
                                                        <ul class="tp-submenu">
                                                    ...
                                                    <!-- second col -->
                                                    <li class="has-dropdown">
                                                        <a href="/shop" class="mega-menu-title">More Pages</a>
                                                        <ul class="tp-submenu">
                                    ...
                                    <li class="has-dropdown has-mega-menu">
                                        ...
                                        <div class="shop-mega-menu tp-submenu tp-mega-menu">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <div class="shop-mega-menu-list">
                                                        <a href="/shop" class="shop-mega-menu-title">Shop Pages</a>
                                                        <ul>
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="shop-mega-menu-list">
                                                        <a href="/shop" class="shop-mega-menu-title">Features</a>
                                                        <ul>
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="shop-mega-menu-list">
                                                        <a href="/shop" class="shop-mega-menu-title">Hover Style</a>
                                                        <ul>
                                                            <li><a href="/shop">Hover Style 1</a></li>
                                                            <li><a href="/shop">Hover Style 2</a></li>
                                                            <li><a href="/shop">Hover Style 3</a></li>
