                ...
                <div class="row">
                    <div class="col-xxl-12">
                        <div class="breadcrumb__content p-relative z-index-1">
                            <h3 class="breadcrumb__title"><Strong>SHOP</Strong></h3>
                                ...
                                <div class="tp-shop-widget-content">
                                    <div class="tp-shop-widget-product">
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="/product-details">
                                                    <img src="{{asset('frontend/assets/img/product/shop/sm/shop-sm-1.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="tp-shop-widget-product-content">
                                                ...
                                                <h4 class="tp-shop-widget-product-title">
                                                    <a href="/product-details">Smart watches wood...</a>
                                                </h4>
                                        ...
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="/product-details">
                                                    <img src="{{asset('frontend/assets/img/product/shop/sm/shop-sm-2.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="tp-shop-widget-product-content">
                                                <div
                                                ...
                                                <h4 class="tp-shop-widget-product-title">
                                                    <a href="/product-details">Decoration for panda.</a>
                                                </h4>
                                                <div class="tp-shop-widget-product-price-wrapper">
                                        ...
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="/product-details">
                                                    <img src="{{asset('frontend/assets/img/product/shop/sm/shop-sm-3.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="tp-shop-widget-product-content">
                                                <div
                                                ...
                                                <h4 class="tp-shop-widget-product-title">
                                                    <a href="/product-details">Trending Watch for Man</a>
                                                </h4>
                                                <div class="tp-shop-widget-product-price-wrapper">
                                        ...
                                        <div class="tp-shop-widget-product-item d-flex align-items-center">
                                            <div class="tp-shop-widget-product-thumb">
                                                <a href="/product-details">
                                                    <img src="{{asset('frontend/assets/img/product/shop/sm/shop-sm-4.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="tp-shop-widget-product-content">
                                                <div
                                                ...
                                                <h4 class="tp-shop-widget-product-title">
                                                    <a href="/product-details">Minimal Backpack.</a>
                                                </h4>
                                                <div class="tp-shop-widget-product-price-wrapper">
                                ...
                                <div class="tp-shop-widget-content ">
                                    <div
                                        ...
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_01.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_02.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_03.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_04.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_05.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_06.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_07.png')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="tp-shop-widget-brand-item">
                                            <a href="#">
                                                <img src="{{asset('frontend/assets/img/product/shop/brand/logo_08.png')}}" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-9 col-lg-8">
                        <div class="tp-shop-main-wrapper">
                                        ...
                                        <div class="row infinite-container">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    ...
                                                    <div class="tp-product-content-2 pt-15">
                                                        ...
                                                        <h3 class="tp-product-title-2">
                                                            <a href="/product-details">Women's Essentials
                                                                Convertible</a>
                                                        </h3>
                                                        <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                            <span><i class="fa-solid fa-star"></i></span>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    ...
                                                    <div class="tp-product-content-2 pt-15">
                                                        ...
                                                        <h3 class="tp-product-title-2">
                                                            <a href="/product-details">Calvin Klein Gabrianna
                                                                Novelty</a>
                                                        </h3>
                                                        <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                            <span><i class="fa-solid fa-star"></i></span>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    ...
                                                    <div class="tp-product-content-2 pt-15">
                                                        ...
                                                        <h3 class="tp-product-title-2">
                                                            <a href="/product-details">Tommy Hilfiger Women’s
                                                                Jaden</a>
                                                        </h3>
                                                        <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                            <span><i class="fa-solid fa-star"></i></span>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="/product-details">
                                                            <img src="{{asset('frontend/assets/img/product/2/prodcut-6.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="/product-details">
                                                            <img src="{{asset('frontend/assets/img/product/2/prodcut-7.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                            ...
                                            <div class="col-xl-4 col-md-6 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="/product-details">
                                                            <img src="{{asset('frontend/assets/img/product/2/prodcut-8.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="/product-details">
                                                            <img src="{{asset('frontend/assets/img/product/2/prodcut-9.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="/product-details">
                                                            <img src="{{asset('frontend/assets/img/product/2/prodcut-10.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                    ...
                                                    <div class="tp-product-content-2 pt-15">
                                                        ...
                                                        <h3 class="tp-product-title-2">
                                                            <a href="/product-details">Full Sleeve Shirt(Pink)</a>
                                                        </h3>
                                                        <div class="tp-product-rating-icon tp-product-rating-icon-2">
                                                            <span><i class="fa-solid fa-star"></i></span>
                                                            <span><i class="fa-solid fa-star"></i></span>
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="/product-details">
                                                            <img src="{{asset('frontend/assets/img/product/2/prodcut-11.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                            ...
                                            <div class="col-xl-4 col-sm-6 infinite-item">
                                                <div class="tp-product-item-2 mb-40">
                                                    <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                        <a href="/product-details">
                                                            <img src="{{asset('frontend/assets/img/product/2/prodcut-12.jpg')}}"
                                                                alt="">
                                                        </a>
                                                        <!-- product action -->
                                                        <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/assets/img/product/list/product-list-1.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                        ...
                                                        <div class="tp-product-list-content">
                                                            <div class="tp-product-content-2 pt-15">
                                                                ...
                                                                <h3 class="tp-product-title-2">
                                                                    <a href="/product-details">Simple Modern School
                                                                        Boys</a>
                                                                </h3>
                                                                <div
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/assets/img/product/list/product-list-2.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/assets/img/product/list/product-list-3.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                        ...
                                                        <div class="tp-product-list-content">
                                                            <div class="tp-product-content-2 pt-15">
                                                                ...
                                                                <h3 class="tp-product-title-2">
                                                                    <a href="/product-details">Black Leather Bag</a>
                                                                </h3>
                                                                <div
                                                                    class="tp-product-rating-icon tp-product-rating-icon-2">
                                                                    <span><i class="fa-solid fa-star"></i></span>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/assets/img/product/list/product-list-4.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/assets/img/product/list/product-list-5.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                        ...
                                                        <div class="tp-product-list-content">
                                                            <div class="tp-product-content-2 pt-15">
                                                                ...
                                                                <h3 class="tp-product-title-2">
                                                                    <a href="/product-details">Legendary Whitetails
                                                                        Men's.</a>
                                                                </h3>
                                                                <div
                                                                    class="tp-product-rating-icon tp-product-rating-icon-2">
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/assets/img/product/list/product-list-6.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        <div class="tp-product-list-thumb p-relative fix">
                                                            <a href="#">
                                                                <img src="{{asset('frontend/assets/img/product/list/product-list-7.jpg')}}"
                                                                    alt="">
                                                            </a>
                                                        ...
                                                        <div class="tp-product-list-content">
                                                            <div class="tp-product-content-2 pt-15">
                                                                ...
                                                                <h3 class="tp-product-title-2">
                                                                    <a href="/product-details">Winter Men's Jacket</a>
                                                                </h3>
                                                                <div
                                                                    class="tp-product-rating-icon tp-product-rating-icon-2">
                                                                    <span><i class="fa-solid fa-star"></i></span>
                                                    ...
                                                    <div class="tp-product-list-item d-md-flex">
                                                        ...
                                                        <div class="tp-product-list-content">
                                                            <div class="tp-product-content-2 pt-15">
                                                                ...
                                                                <h3 class="tp-product-title-2">
                                                                    <a href="/product-details">Full Sleeve Shirt For
                                                                        Men</a>
                                                                </h3>
                                                                <div
                                                                    class="tp-product-rating-icon tp-product-rating-icon-2">
                            ...
                            <div class="infinite-pagination d-none">
                                <a href="/shop" class="infinite-next-link">Next</a>
                            </div>
                            <div class="tp-shop-pagination mt-20">
                                <div class="tp-pagination">
                                    <nav>
                                        <ul>
                                            <li>
                                                <a href="/shop" class="tp-pagination-prev prev page-numbers">
                            ...
                            <div class="tab-content m-img" id="productDetailsNavContent">
                                <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                    ...
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{asset('frontend/assets/img/product/details/main/product-details-main-1.jpg')}}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-2" role="tabpanel"
                                    ...
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{asset('frontend/assets/img/product/details/main/product-details-main-2.jpg')}}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-3" role="tabpanel"
                                    ...
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{asset('frontend/assets/img/product/details/main/product-details-main-3.jpg')}}"
                                            alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-4" role="tabpanel"
                                    ...
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{asset('frontend/assets/img/product/details/main/product-details-main-4.jpg')}}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
