                   ...
                   <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="tp-login-option">
                        <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                           ...
                           <div class="tp-login-option-item">
                              <a href="#">
                                 <img class="apple" src="{{asset('frontend/assets/img/icon/login/apple.svg')}}" alt="">
                              </a>
                           </div>
                        </div>
                        ...
                        <div class="tp-login-input-wrapper">
                           <div class="tp-login-input-box">
                              <div class="tp-login-input">
                                 <input id="name" type="text" placeholder="Type you Name" class="@error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                 @error('name')
                           ...
                           <div class="tp-login-input-box">
                              <div class="tp-login-input">
                                <input id="email" type="email" placeholder="sample@mail.com" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                           ...
                           <div class="tp-login-input-box">
                              <div class="tp-login-input">
                                 ...
                                 <input id="tp_password" type="password" placeholder="Min. 8 character" class=" @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                           ...
                           <div class="tp-login-input-box">
                            <div class="tp-login-input">
                                <input id="password-confirm tp_password" type="password" placeholder="Confirm Your Password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                        ...
                        <div class="tp-login-bottom">
                           <button  class="tp-login-btn w-100">Sign Up</button>
                        </div>
                     </div>
