                            ...
                            <div class="tp-login-option">
                                <div
                                    ...
                                    <div class="tp-login-option-item has-google">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/img/icon/login/google.svg') }}"
                                                alt="">
                                            Sign in with google
                                        </a>
                                    </div>
                                    <div class="tp-login-option-item">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/img/icon/login/facebook.svg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="tp-login-option-item">
                                        <a href="#">
                                            <img class="apple"
                                                src="{{ asset('frontend/assets/img/icon/login/apple.svg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <form action="{{ route('login') }}" method="post">
                                    ...
                                    <div class="tp-login-input-wrapper">
                                        <div class="tp-login-input-box">
                                            <div class="tp-login-input">
                                                <input id="email" type="email" placeholder="sample@mail.com"
                                        ...
                                        <div class="tp-login-input-box">
                                            <div class="tp-login-input">
                                                <input id="tp_password" class="@error('password') is-invalid @enderror"
                                    ...
                                    <div
                                        ...
                                        <div class="tp-login-remeber">
                                            <input id="remeber" type="checkbox" {{ old('remember') ? 'checked' : '' }}>
